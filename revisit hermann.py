...
# Overall, we saw that the validation set tuned f1 score for the models was: LR = 79.07% vs. RF = 91.56% vs. XGB = 93.67% (when using the eval method otherwise it was 89.4364% with an error of 0.0625). The AUC score for how the model perform on the validation set was: LR = 78.43% vs. RF = 92.92% vs. XGB = 91.56%. Overall, the XGBoost model performed the best. It had the higher f1 score even though it had a lower AUC score than RF. We will move forward with this model to get the feature importance and then do the regression to see what the relationships are.
f = 'total_gain'
